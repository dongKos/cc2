	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-10 col-md-10 col-xs-10">
				<form action="updateRound.wt" method="post"
							...
							<table class="insertWtrTable">
								<tr>
									...
									<td class="wtrContent"> <input class="insertWtrInput"
										type="text" name="rTitle" value="${ wr.rTitle }"
										maxlength="40" autofocus required>
									</td>
									<td>
										<input type="hidden" name="rid" value="${ wr.rid }">
										<input type="hidden" name="wid" value="${ wr.wid }">
									</td>
								</tr>
								<tr>
									...
									<td class="wtContent">
										<div class="imgBox">
											...
											<input type="hidden" name="subChangeName" value="${ subChangeName.changeName }"/>
								...
								<tr>
									...
									<td class="wtContent">
										<div class="imgBox">
											...
											<input type="hidden" name="contChangeName" value="${ contChangeName.changeName }"/>
								...
								<tr>
									<td colspan="2" class="wtContent"><textarea
											class="wrComment" name="wrComment">${ wr.wrComment }</textarea></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="lastTd" colspan="2">
										...
										<div class="wtrBtn">
											...
											&nbsp;&nbsp;&nbsp;
											<button class="insertwtrBtn" type="submit">회차 수정</button>
										</div>
									</td>
								</tr>
							</table>
