	...
	<div class="genreNav">
		<table class="genreMenu">
			<tr>
				...
				<td class="genreItem" id="5" onClick="genreMenu('GR_CTG4',2)">액션</td>
				<td class="genreItem" id="6" onClick="genreMenu('GR_CTG5',2)">로멘스</td>
				<td class="genreItem" id="7" onClick="genreMenu('GR_CTG6',2)">스릴러</td>
				<td class="genreItem" id="7" onClick="genreMenu('GR_CTG7',2)">스포츠</td>
			</tr>
		</table>
	</div>
