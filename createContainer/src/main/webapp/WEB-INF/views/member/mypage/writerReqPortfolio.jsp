    ...
    <div class="col-sm-7">
      <div class="point">
					<ul class="nav nav-tabs">
    					<li style="width:50%; text-align:center;"><a href="writerReqPremium.mg">유료 작품 신청</a></li>
    					<li class="active" style="width:50%; text-align:center;"><a href="writerReqPortfolio.mg" style="font-weight:bold;">정식 포트폴리오 신청</a></li>
