...
<body>
	...
	<div class="container">
		...
		<br>
		<br><br>
		<h1>선택할 수 있는 후원 작품이에요!</h1>
		<br>
		<br>
		<br><br>
		<div class="row">
			<c:forEach var="illSupportReward" items="${ srlist }">
				<div class="reward" onclick="apply();">
					<div class="img-content">
						<img
							src="${contextPath }/resources/uploadFiles/support/${ illSupportReward.changeName }"
							style="width: 100%; height: 100%;">
					</div>
					<hr>
					<div class="textArea">
						<h2>${ srlist[0].stitle}</h2>
						<span style="font-size: 15px;">${srlist[0].scontent}</span>
