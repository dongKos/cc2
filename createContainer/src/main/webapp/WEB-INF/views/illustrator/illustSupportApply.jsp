...
(부칙) 이 약관은 2016년 10월 15일부터 적용됩니다. 종전의 약관은 본 약관으로 대체합니다.</textarea>
             <br><br><input type="checkbox" required style="width:15px; height:15px;"><label style="font-size:15px">내용에
               동의 합니다</label> <br> <br>
         </div>
         
         <div class="col-lg-10" style="margin-top: 4%;">
            <div class="form-inline">
               <label style="font-size:15px">후원 금액 : </label><input type="number"
                  class="form-control" placeholder="후원할 금액을 입력해주세요!" id="price" style="width:30%; margin-left:3%">

               <button class="btn btn-primary" onclick="support();" style="height: 35px; font-size: 18px; margin-left:5%">후원하기</button>
               </div>
               <br><br><br><br><br>   
         </div>
      </div>
