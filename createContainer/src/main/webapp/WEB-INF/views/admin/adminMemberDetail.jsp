	                                        ...
	                                        <!-- 웹 소설 일때 -->
	                                        	<c:if test="${w.workType eq  'WN'}">
			                                        ...
			                                        <div class="img-content mt-5">
			                                       		<img src="${ contextPath }/resources/uploadFiles/webnovelMain/${ w.changeName }" alt="Card image cap" width="300px"style="height:200px;">
			                                        </div>
			                                        <div class="info-content pl-5">
			                                        	<p align="left"><font color="red">[웹소설]</font></p>
			                                        	<p align="left" class="mb-2">
			                                        		<span class="mr-5" style="font-size:24px;font-weight:bold;color: #333333;">${w.wTitle }</span>
			                                        		<span class="ml-5"><strong>등록일</strong> : ${ w.wuploadDate}</span>&nbsp;&nbsp;&nbsp;<span><strong>조회수 </strong>: ${w.vCount }</span>
			                                        	</p>
			                                        	<br>
			                                        	<p align="left" class="mb-1"><strong>작품소개</strong></p>
	                                        	...
	                                        	<c:if test="${w.workType eq 'WT'}">
			                                        <br>
			                                        <div class="img-content mt-5">
			                                       		<img src="${ contextPath }/resources/uploadFiles/webtoonMain/${ w.changeName }" alt="Card image cap" width="300px"style="height:200px;">
			                                        </div>
			                                        <div class="info-content pl-5">
			                                        	<p align="left"><font color="red">[웹툰]</font></p>
			                                        	<p align="left" class="mb-2">
			                                        		<span class="mr-5" style="font-size:24px;font-weight:bold;color: #333333;">${w.wTitle }</span>
			                                        		<span class="ml-5"><strong>등록일</strong> : ${ w.wuploadDate}</span>&nbsp;&nbsp;&nbsp;<span><strong>조회수 </strong>: ${w.vCount }</span>
			                                        	</p>
