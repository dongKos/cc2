...
<jsp:include page="../member/mypage/common/mypageNavbar.jsp"/>
	...
	<pre style="background:white; width:80%; border:none; margin:0 auto; white-space: pre-wrap; font-size:10px; ">
제 1 조 (목적)
이 약관은 네이버 주식회사("회사")가 제공하는 그라폴리오(www.grafolio.com) 및 그라폴리오 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.

①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 그라폴리오(grafolio.com) 및 그라폴리오 관련 제반 서비스를 의미합니다.
...
⑥"콜라보레이션"이라 함은 회사가 회원을 대상으로 특정한 주제의 게시물을 제안받고 심사하여 상금 혹은 특전을 제공하는 콘테스트를 의미합니다.
제 3 조 (약관의 게시와 개정)
...
②"회원"이 "서비스" 내에 게시하는 "게시물"은 검색결과 내지 "서비스", 네이버 서비스 및 관련 프로모션 등에 노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있습니다. 이 경우, 회사는 저작권법 규정을 준수하며, "회원"은 언제든지 고객센터 또는"서비스" 내 관리기능을 통해 해당 게시물에 대해 삭제, 검색결과 제외, 비공개 등의 조치를 취할 수 있습니다.
③"회사"는 제2항 이외의 방법으로 "회원"의 "게시물"을 이용하고자 하는 경우에는 전화, 전자우편 등을 통해 사전에 "회원"의 동의를 얻어야 합니다. 다만 "회원"이 "콜라보레이션"에 참여하여 심사를 받고 상금 또는 특전을 받은 게시물에 대해서는 "회사"가 해당 페이지 내에서 이를 게시할 권리를 갖습니다.
제 15 조 ("게시물"의 관리)
...
③"회원"이 계약을 해지하는 경우, "회원"이 작성한 게시물 일체는 삭제됩니다. 다만, "콜라보레이션"을 통해 상금 또는 특전을 받은 게시물은 해당 "콜라보레이션" 에 그대로 존속 유지됩니다
제 18 조 (이용제한 등)
