...
<body>
	...
	<!-- 웹소설 장르 네비바 -->
	<jsp:include page="../webnovelChallenge/challengeGenre.jsp"/>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<jsp:include page="../webnovelChallenge/challengeTop5.jsp"/>
			</div>
			<div class="col-sm-1"></div>
		</div><br><br>
		...
		<div class="row">
			<div class="col-sm-1"></div>
			<div class="col-sm-10 ">
				<jsp:include page="../webnovelChallenge/newChallengeList.jsp"/>
				<div class="col-sm-4">
	...
	<jsp:include page="../webnovelChallenge/challengeBestGenre.jsp"/>
