...
public class IllustratorPhotoMain implements java.io.Serializable{
	private int fid;
	...
	public IllustratorPhotoMain() {}

	public IllustratorPhotoMain(int fid, String originName, String changeName, String filePath, Date uploadDate,
	...
	public String toString() {
		return "IllustratorPhotoMain [fid=" + fid + ", originName=" + originName + ", changeName=" + changeName
