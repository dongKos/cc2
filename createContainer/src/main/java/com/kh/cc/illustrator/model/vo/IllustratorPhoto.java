...
public class IllustratorPhoto implements java.io.Serializable{
	private int fid;
	...
	public IllustratorPhoto() {}

	public IllustratorPhoto(int fid, String originName, String changeName, String filePath, Date uploadDate,
	...
	public String toString() {
		return "IllustratorPhoto [fid=" + fid + ", originName=" + originName + ", changeName=" + changeName
