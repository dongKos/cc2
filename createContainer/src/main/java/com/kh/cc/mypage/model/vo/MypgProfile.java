...
public class MypgProfile implements java.io.Serializable {
	...
	public MypgProfile(int mno, String userId, String userPwd, String userName, String nickname, int memberType,
	...
	public String toString() {
		return "MypgProfile [mno=" + mno + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
