...
public class WriterPhoto {
	...
	public WriterPhoto(int fid, String originName, String changeName, String filePath, Date uploadDate, String status,
	...
	public String toString() {
		return "WriterPhoto [fid=" + fid + ", originName=" + originName + ", changeName=" + changeName + ", filePath="
