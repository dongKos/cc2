...
public class MypgPhoto {
	...
	public MypgPhoto(int fid, String originName, String changeName, String filePath, Date uploadDate, String status,
	...
	public String toString() {
		return "MypgPhoto [fid=" + fid + ", originName=" + originName + ", changeName=" + changeName + ", filePath="
