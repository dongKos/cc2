...
public class AdminPageInfo implements java.io.Serializable{
	...
	public AdminPageInfo(int currentPage, int listCount, int limit, int maxPage, int startPage, int endPage) {
		super();
